...
class TestimoniesControllerTest < ActionController::TestCase
  ...
  test "should create testimony" do
    assert_difference('Testimony.count') do
      post :create, testimony: { content: @testimony.content, occupation: @testimony.occupation, person: @testimony.person }
    end
  ...
  test "should update testimony" do
    patch :update, id: @testimony, testimony: { content: @testimony.content, occupation: @testimony.occupation, person: @testimony.person }
    assert_redirected_to testimony_path(assigns(:testimony))
  end
